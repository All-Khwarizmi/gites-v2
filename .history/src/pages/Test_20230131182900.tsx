  ...
  return (
    <>
      <div className="test">
        ...
        <section onClick={handleClick} ref={divPosition} className="section ">
            ...
            <Card maxW={"900px"}>
              ...
              <CardBody>
                <Text className="welcome-text">
                  Pour des vacances au soleil, sur des plages de sable blanc ou
                  de belles balades dans une verdure luxuriante : les Gîtes Mon
                  ...
                  tous commerces. Nous avons l'énorme chance de n'avoir jamais
                  de sargasses sur nos plages les plus proches. Bonne visite !
                </Text>
              </CardBody>
            </Card>
          </div>
