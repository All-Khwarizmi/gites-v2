...
const Gites = () => {
  return (
    <>
      <div className="grid-rows grid place-items-center gap-3 pt-5 lg:grid lg:grid-cols-3">
      ...
      <div className="grid-rows pt-2 grid place-items-center gap-3 lg:grid lg:grid-cols-3">
