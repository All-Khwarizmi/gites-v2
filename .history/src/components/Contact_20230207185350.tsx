...
const Contact = () => {
  ...
  return (
    <>
      {/* 1st div container */}
      <div className="lg:place-items-center flex-col items-center  justify-center gap-5 lg:relative lg:grid lg:w-full">
        {/* Form div */}
        ...
        {/* Grid div */}
        <div className="top-40 m-0 grid min-h-[100%] w-[80%]  lg:w-full lg:grid-cols-2  gap-3 border-0 pb-5  lg:absolute lg:left-10 lg:min-h-[40%] lg:w-[40%]  ">
          {/* 4 divs  */}
