...
const Gites = () => {
  return (
    <>
      ...
      <div className="grid-rows grid place-items-center gap-3 lg:grid lg:grid-cols-3">
        <div className="mt-1 rounded bg-white bg-blue-500 transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 sm:hidden lg ">
          <h3 className="px-4 py-2 text-2xl">Gîte Palmier</h3>
        </div>
      </div>
    </>
