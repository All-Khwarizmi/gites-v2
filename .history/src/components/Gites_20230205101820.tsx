...
const Gites = () => {
  return (
    <div className="grid-rows grid place-items-center gap-3 lg:grid lg:grid-cols-3">
      <div className="sm:flex-rows-2 place-items-center content-center ">
        <div className="lg:h-500 rotate-x-6 group relative flex skew-y-3 cursor-pointer flex-col justify-center overflow-hidden rounded-md py-5 text-center sm:px-10 md:px-5 lg:w-[100%] ">
          <img
