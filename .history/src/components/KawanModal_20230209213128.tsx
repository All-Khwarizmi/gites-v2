...
const KawanModal = ({ slides }: any) => {
  ...
  return (
    <div className="flex place-items-center rounded-1 content-center justify-center bg-black lg:hidden ">
      <h3
        onClick={onOpen}
        className=" w-40 rounded bg-white  px-4 py-2 text-center text-2xl  transition delay-150 duration-300  ease-in-out hover:-translate-y-1 hover:scale-110 btn-blk"
      >
        Gîte Kawan
      </h3>
