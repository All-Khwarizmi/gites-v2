...
const PalmierModalLG = ({ slides }: any) => {
  ...
  return (
    <div className="flex rounded place-items-center content-center justify-center  bg-black transition delay-150  duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 w-40">
      <h3
        onClick={onOpen}
        className=" btn-blk w-40 rounded bg-white px-4 py-2 text-center text-2xl  "
      >
        Gîte Palmier
      </h3>
      <div>
