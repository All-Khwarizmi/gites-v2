            ...
            <ModalBody className="m-0  w-full  gap-5 px-0">
              ...
              <div className="grid grid-rows-2">
                <div>
                  ...
                  et , une salle de bain avec douche et WC, un salon avec un
                  canapé et une télévision TNT, une cuisine équipée (cuisinière
                  à gaz, micro-ondes, réfrigérateur/congélateur, cafetière,
