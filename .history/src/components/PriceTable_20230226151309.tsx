          ...
          <div className="  w-4/5  ">
            <div className="pricingTable10">
              <div className="pricingTable-header">
                ...
                <h3 className="heading uppercase">Du 1/05 au 30/06</h3>
                <h3 className="heading uppercase">&</h3>
                <h3 className="heading uppercase">Du 1/09 au 31/10</h3>
              </div>
          ...
          <div className=" w-4/5 ">
            <div className="pricingTable10">
              <div className="pricingTable-header ">
                ...
                <h3 className="heading uppercase pb-7 ">Du 1/11 au 30/04</h3>
              </div>
              <div className="pricing-content">
                <div>
                  <ul></ul>
          ...
          <div className=" w-4/5 ">
            <div className="pricingTable10">
              <div className="pricingTable-header">
                ...
                <h3 className="heading uppercase pb-7 ">Du 1/07 au 31/08</h3>
              </div>
              <div className="pricing-content">
                <div>
                  <ul></ul>
