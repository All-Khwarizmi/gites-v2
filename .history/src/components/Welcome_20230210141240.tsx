...
const Welcome = () => {
  return (
    <div className=" flex w-[100%] justify-center py-20  px-5 lg:mb-10 border-double border-2 border-black">
      <Card className="w-[100%] lg:w-[60%]">
        <Heading className="flex-column flex place-items-center justify-center p-2 text-center">
          <p  className={clsx(cabin.className, "font-bold")}> Bienvenue en Guadeloupe !</p>
        </Heading>
        <CardBody>
