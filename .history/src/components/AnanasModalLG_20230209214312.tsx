...
const AnanasModalLG = ({ slides }: any) => {
  ...
  return (
    <div className="w-50 pt-5 flex place-items-center content-center justify-center  rounded bg-black transition  delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110">
      <h3
        onClick={onOpen}
