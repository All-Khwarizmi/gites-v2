...
const Contact = () => {
  ...
  return (
    <>
      {/* 1st div container */}
      <div className="grid  w-full place-items-center justify-center gap-5 lg:relative">
        {/* Form div */}
        <div className="lg:m-0 ml-10 mr-10 w-screen gap-3 bg-gray-100  lg:absolute lg:top-40 lg:right-20 lg:min-h-[50%]  lg:w-[50%] lg:p-2">
