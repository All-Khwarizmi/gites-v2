          ...
          <ModalContent>
            <ModalBody className="grid w-full grid-cols-2 gap-2">
              ...
              <div>
                ...
                et une chambre avec deux lits simples (90cm), une salle de bain
                avec douche et WC, un salon avec un canapé et une télévision
                TNT, une cuisine équipée (cuisinière à gaz, micro-ondes,
                réfrigérateur/congélateur, cafetière, grille-pain), une terrasse
                avec un coin repas et un hamac. Parking et Wifi gratuit Accès à
                la piscine et au barbecue Climatisation dans les chambres (20h à
                8h) Linge fournis (draps, linge de toilette, torchons)
