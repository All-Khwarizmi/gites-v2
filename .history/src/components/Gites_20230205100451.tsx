  ...
  return (
    <div className="grid-rows grid place-items-center gap-3 lg:grid lg:grid-cols-3">
      <div className="flex-row  gap-10">
        <div className="lg:h-500 rotate-x-6 group relative flex skew-y-3 cursor-pointer flex-col justify-center overflow-hidden rounded-md text-center sm:px-10 md:px-5 py- lg:w-[80%] ">
          <img
