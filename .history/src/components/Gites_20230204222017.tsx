  ...
  return (
    <><div className="grid grid-rows-3 place-items-center gap-3 lg:grid lg:grid-cols-3">
      <div className="lg:h-500 px-4 lg:w-[80%]  ">
        <img
          className="h-100 w-50 shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)]  object-cover ease-in-out duration-500 group-hover:rotate-6 group-hover:scale-125"
    ...
    </div><div className="lg:h-500 px-4 lg:w-[80%] ">
        <img
