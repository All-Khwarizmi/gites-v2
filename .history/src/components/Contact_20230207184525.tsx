...
const Contact = () => {
  ...
  return (
    <>
      {/* 1st div container */}
      <div className="lg:grid w-4/5 flex flex-row w-full lg:place-items-center items-center justify-center gap-5 lg:relative">
        {/* Form div */}
        <div className="lg:m-0  div-form gap-3 bg-gray-100  lg:absolute lg:top-40 lg:right-20 lg:min-h-[50%]  lg:w-[50%] lg:p-2">
