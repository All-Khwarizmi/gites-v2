...
const Contact = () => {
  ...
  return (
    <>
      ...
      <h3
className="flex mt-5 place-items-center content-center justify-center  rounded bg-black  transition delay-150 duration-300  ease-in-out hover:-translate-y-1 hover:scale-110 lg:hidden "
