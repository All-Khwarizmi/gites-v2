     ...
     <div className="grid-row grid place-items-center ">
       ...
       <div className=" align-center flex place-items-center gap-4 p-5 lg:w-[80%]">
         ...
         <div className=" w-[60%]">
           ...
           alentours : La Pointe de la Grande Vigie La Porte d’Enfer avec le
           trou de Man Coco Les plages : plage de La Chapelle, l’Anse Laborde,
           l’Anse Colas et la magnifique plage du Souffleur avec sa base
           nautique Les Marches des Esclaves et l’ancienne prison à Petit-Canal
         </div>
       </div>
       <div></div>
     </div>
