  ...
  return (
    <>
      <div className="grid-rows grid place-items-center gap-3 lg:grid lg:grid-cols-3">
        <div className="rotate-x-6 lg:h-500 lg:w-[100%] group relative flex skew-y-3 cursor-pointer flex-col justify-center overflow-hidden rounded-md py-5 text-center sm:px-10 md:px-5 ">
          <img
