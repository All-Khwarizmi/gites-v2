...
const Contact = () => {
  ...
  return (
    <>
      ...
      <h3
className="flex place-items-center content-center justify-center rounded bg-black  transition delay-150 duration-300  ease-in-out hover:-translate-y-1 hover:scale-110 lg:hidden "
      
      >
        <p   className={clsx(
          cabin.className,
          "btn-blk w-40 w-40 rounded px-4 py-2 text-center  text-2xl font-bold   transition"
        )}>
             envoyer
        </p>
