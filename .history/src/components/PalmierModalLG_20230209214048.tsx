...
const PalmierModalLG = ({ slides }: any) => {
  ...
  return (
    <div className="flex bg-black place-items-center content-center justify-center ">
      <h3
        onClick={onOpen}
        className=" w-40 rounded bg-white btn-blk px-4 py-2 text-center text-2xl  transition delay-150 duration-300  ease-in-out hover:-translate-y-1 hover:scale-110 "
      >
        Gîte Palmier
      </h3>
      <div>
