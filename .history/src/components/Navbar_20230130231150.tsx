...
function MobileNav({ open, setOpen }: any) {
  return (
    <div
      className={` top-0 left-0 h-screen w-screen transform  ${
        open ? "-translate-x-0" : "-translate-x-full"
      } drop-shadow-md filter transition-transform duration-300 ease-in-out `}
    >
      <div className="flex h-20 items-center justify-center  drop-shadow-md filter">
        {" "}
        {/*logo container*/}
...
export default function Navbar() {
  ...
  return (
    <nav className="flex h-20 items-center  px-4 py-4 drop-shadow-md filter">
