 ...
 const diapos = slides.slidesAnanas;
  ...
  return (
    <div className="btn-div flex place-items-center  content-center  justify-center rounded lg:hidden ">
      <h3
        onClick={onOpen}
        className=" btn-blk w-40 rounded px-4 py-2  text-center text-2xl transition   transition delay-150 delay-150 duration-300 duration-300 ease-in-out ease-in-out hover:-translate-y-1  hover:-translate-y-1 hover:scale-110 hover:scale-110   "
      >
        Gîte Ananas
      </h3>
      <div>
