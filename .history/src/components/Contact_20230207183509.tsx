  ...
  return (
    <>
      ...
      <div className="grid h-screen w-full place-items-center justify-center gap-1 lg:relative">
        {/* Form div */}
        <div className="lg:top-40 lg:right-20 m-0 w-[100%] place-items-center justify-center gap-3 bg-gray-100 lg:absolute lg:min-h-[50%]  lg:w-[50%] lg:p-2">
          <h2 className="text-center text-2xl lg:pt-5">Contactez-nous</h2>
          <form
            className="flex flex-col rounded w-full p-5 lg:py-5 lg:px-40"
            onSubmit={onSubmit}
          >
            <label>Nom</label>
