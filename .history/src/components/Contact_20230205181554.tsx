...
const Contact = () => {
  ...
  return (
    <>
      {/* 1st div container */}
      <div className="h-screen w-full flex-cols-2 gap-3  lg:relative">
        {/* Form div */}
        <div className="top-40 right-20 m-0 flex  min-h-[50%] w-[50%] place-items-center justify-center gap-3  bg-gray-100 lg:absolute">
          <form
