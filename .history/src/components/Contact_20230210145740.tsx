  ...
  return (
    <>
      <div className="grid w-full place-items-center ">
        <div className="eight w-2/3 py-10 lg:pb-20 pt-32 ">
      ...
      <div className=" grid  place-items-center gap-5  lg:flex ">
        <div></div>
        {/* Grid div */}
        <div className="w-[40%] grid place-items-center lg:place-items-center">
          {" "}
        ...
        {/* Form div */}
        <div className="  w-[50%] gap-3 bg-gray-100 lg:m-0  ">
          <form
            ref={form}
          ...
          >
            ...
            <input {...register("user_", { required: true })} />
            <label>Email</label>
