...
const AnanasModalLG = ({ slides }: any) => {
  ...
  return (
    <div className="flex place-items-center content-center justify-center  transition delay-150  w-40 bg-black duration-300  ease-in-out hover:-translate-y-1 hover:scale-110 ">
      <h3
        onClick={onOpen}
