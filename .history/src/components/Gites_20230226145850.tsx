  ...
  return (
    <>
      ...
      <div className="grid-rows grid place-items-center gap-3 lg:grid lg:grid-cols-3 lg:pt-5">
        <div className="rotate-x-6 lg:h-500 group relative flex   flex-col justify-center overflow-hidden rounded-md py-5 px-1 text-center md:px-5 lg:w-[80%] ">
          <img
            className="rotate-x-6 h-auto  w-auto  shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] duration-500 ease-in-out hover:rotate-2 hover:scale-125"
            src="/ananas.jpg"
            alt="Gite Ananas"
            width={500}
            height={100}
        ...
        <div className="lg:h-800 group relative flex py-5 justify-center overflow-hidden rounded-md px-1 text-center md:px-5 lg:w-[80%] ">
          <img
            className="h-auto   rounded  shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] duration-500 ease-in-out hover:rotate-2 hover:scale-125"
            src="/kawan.jpg"
            alt="Gite Kawan"
            width={1000}
            height={100}
        ...
        <div className="lg:h-800 group relative flex  justify-center overflow-hidden rounded-md px-1 text-center md:px-5   lg:w-[80%] ">
          <img
            className="h-auto w-auto   shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] duration-500 ease-in-out hover:rotate-2 hover:scale-125"
            src="/palmier.jpg"
            alt="Gite Palmier"
            width={500}
            height={100}
