    ...
    <div className="grid-row grid place-items-center ">
      ...
      <div className=" align-center place-items-center gap-4 p-5 md:flex lg:w-[80%]">
        ...
        <div className=" flex place-items-center md:w-[60%]">
          ...
          <ul>
            <li>
              <p> plage de La Chapelle</p>
            </li>
            <li>
              <p>La Porte d’Enfer avec le trou de Man Coco</p>
            </li>
          </ul>
          plage de La Chapelle, l’Anse Laborde, l’Anse Colas et la magnifique
          plage du Souffleur avec sa base nautique Les Marches des Esclaves et
          l’ancienne prison à Petit-Canal
        </div>
      </div>
      <div></div>
    </div>
