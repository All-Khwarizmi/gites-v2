...
const Contact = () => {
  ...
  return (
    <>
      ...
      {/* 1st div container */}
      <div className=" grid  place-items-center gap-5  lg:grid-cols-2 lg:w-full ">
        <div></div>
        {/* Grid div */}
        <div className="grid-wrap top-40 m-0 grid min-h-[100%] w-[80%] gap-3  border-0 pb-5 md:grid-cols-2  lg:min-h-[40%] lg:w-[40%]  ">
          {/* 4 divs  */}
        ...
        {/* Form div */}
        <div className="div-form  w-[80%] gap-3 bg-gray-100 px-5 lg:right-20 lg:m-0 lg:min-h-[50%]  lg:w-[50%] lg:p-2">
          <form
            ref={form}
