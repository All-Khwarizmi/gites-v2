...
const Contact = () => {
  ...
  return (
    <>
      {/* 1st div container */}
      <div className="flex-col content-center justify-center  gap-5 lg:relative lg:grid lg:w-full lg:place-items-center">
        {/* Form div */}
        ...
        {/* Grid div */}
        <div className="top-40 m-0 lg:grid min-h-[100%] w-[80%]  gap-3 border-0  pb-5 lg:absolute lg:left-10  lg:min-h-[40%] lg:w-full lg:w-[40%] lg:grid-cols-2  ">
          {/* 4 divs  */}
