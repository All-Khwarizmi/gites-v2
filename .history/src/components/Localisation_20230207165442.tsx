    ...
    <div className="grid-row grid place-items-center ">
      ...
      <div className="  align-center flex items-center justify-center gap-4 p-5 lg:flex lg:w-[70%]">
        <div>
          ...
          <div className=" flex lg:w-[40%] items-center justify-center md:h-[100%] md:w-full lg:bg-white ">
            <div>
              <p className=" w-[40%] md:w-[60%] ">
                À 30 minutes (27km) de l’aéroport Pôle Caraïbes, desservie par
                Air France, Air Caraïbes, Corsair, Air Canada, Air Belgium.
              </p>
