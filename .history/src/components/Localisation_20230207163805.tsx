...
const Localisation = () => {
  ...
  return (
    <div className="grid-row grid place-items-center ">
      ...
      <div className="  place-items-center gap-4 p-5 md:flex lg:w-[80%]">
        <div>
          {" "}
          <Maps coords={dimensions} />
        </div>

        <div className=" flex justify-center md:bg-white w-full h-full place-items-center">
          <div>
            <p className=" md:w-[60%] w-[60%] ">
