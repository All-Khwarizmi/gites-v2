...
const AnanasModalLG = ({ slides }: any) => {
  ...
  return (
    <div className="flex w-screen place-items-center content-center justify-center  transition delay-150  w-40 bg-black duration-300  ease-in-out hover:-translate-y-1 hover:scale-110 ">
      <h3
        onClick={onOpen}
        className=" w-40 rounded bg-white bg-blue-500 px-4 py-2 text-center text-2xl  btn-blk"
      >
        Gîte Ananas
      </h3>
      <div>
