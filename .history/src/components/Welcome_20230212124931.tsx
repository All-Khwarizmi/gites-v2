      ...
      <Card className="welcome w-[100%]  border-4 border-double border-black bg-transparent lg:w-[60%]">
        ...
        <CardBody>
          <div className="welcome-text text-2xl">
            ...
            commune d'ANSE-BERTRAND, à 3 km des plages et de tous commerces.
            Nous avons l&apos;énorme chance de n'avoir jamais de sargasses sur
            nos plages les plus proches. Bonne visite !
          </div>
        </CardBody>
      </Card>
    </div>
