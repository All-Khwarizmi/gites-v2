...
const style = {backgroundColor: color, color: colorFont}
    ...
    return (
      ...
      <nav style={style} classNameName="nav p-2 flex w-full">
  ...
  <li className="mr-6">
    <a className={` flex-initial text-2xl ${style.color} text-justify   hover:underline`} href="#">Gîtes</a>
  </li>
  <li className="mr-6">
    <a className={` flex-initial text-2xl ${style.color} text-justify   hover:underline`} href="#">Localisation</a>
  </li>
  <li className="mr-6">
    <a className={` flex-initial text-2xl ${style.color} text-justify   hover:underline`} href="#">Tarifs</a>
  </li>
  <li className="mr-6">
    <a className={` flex-initial text-2xl ${style.color} text-justify   hover:underline`} href="#">Contact</a>
  </li>
  <li className="mr-6">
    <a className={` flex-initial text-2xl ${style.color} text-justify   hover:underline`} href="#">Partenariats</a>
  </li>
