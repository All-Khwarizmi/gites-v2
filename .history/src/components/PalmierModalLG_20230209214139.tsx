...
const PalmierModalLG = ({ slides }: any) => {
  ...
  return (
    <div className="flex rounded place-items-center content-center justify-center  bg-black transition delay-150  duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 w-50">
      <h3
        onClick={onOpen}
