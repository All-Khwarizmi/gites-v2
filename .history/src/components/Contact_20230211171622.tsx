  ...
  return (
    <>
      ...
      <div className=" grid  place-items-center gap-5  lg:flex ">
        <div></div>
        {/* Grid div */}
        <div className="grid w-full place-items-center lg:w-[60%] lg:place-items-center">
          {" "}
          <div className="   m-0 grid min-h-[100%] w-[80%] gap-3  border-0 pb-5 md:grid-cols-2   ">
            ...
            <div className=" grid place-items-center gap-2 bg-white py-5">
              ...
              {/* 3 divs flex */}
              <div className="text-2xl font-bold">Notre bureau principal</div>
            ...
            <div className=" grid place-items-center gap-2 bg-white py-5">
              ...
              {/* 3 divs flex */}
              <div className="text-2xl font-bold">Numéro de téléphone</div>
            ...
            <div className=" grid place-items-center gap-2 bg-white py-5">
              ...
              <div className="text-2xl font-bold">Adresse</div>
