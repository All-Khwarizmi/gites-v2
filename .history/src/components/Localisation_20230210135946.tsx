            ...
            <div className=" flex w-[100%] items-center justify-center md:h-[100%] ">
              <div className="flex-col gap-5  py-5 md:grid md:grid-cols-3">
                <div className="pl-2 text-center">
                  <p className={clsx(cabin.className, "text-2xl font")}>Accès:</p>
                  <p className="">
                ...
                <div className="text-center">
                  <p className={clsx(cabin.className, "text-2xl font")}> À visiter aux alentours :</p>
                  <ul>
                    <li>
                ...
                <div className="text-center">
                  <p className={clsx(cabin.className, "text-2xl font")}> Les plages :</p>
                  <ul>
                    <li>
