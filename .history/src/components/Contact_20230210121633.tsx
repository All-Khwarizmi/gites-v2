    ...
    <>
      <div className="grid w-full place-items-center ">
        <div className="eight w-2/3 py-10 pt-32 ">
          <h1 className={clsx(import clsx from "clsx";
import { cabin } from "../pages/_app";) } >Contact</h1>
        </div>
      </div>
      {/* 1st div container */}
      <div className=" grid  place-items-center gap-5  lg:w-full lg:grid-cols-2 ">
        <div></div>
        {/* Grid div */}
        <div className="grid-wrap top-40 m-0 grid min-h-[100%] w-[80%] gap-3  border-0 pb-5 md:grid-cols-2   ">
          {/* 4 divs  */}
        ...
        {/* Form div */}
        <div className="div-form  w-[80%] gap-3 bg-gray-100 px-5  lg:m-0 lg:w-[80%] lg:p-2">
          <form
            ref={form}
