  ...
  return (
    <>
      ...
      <div className=" grid  place-items-center gap-5  lg:flex lg:w-full ">
        <div></div>
        {/* Grid div */}
        <div className="w-full grid lg:place-items-stretch place-items-center">
          {" "}
          <div className=" relative top-0  m-0 grid min-h-[100%] w-[80%] gap-3  border-0 pb-5 md:grid-cols-2   ">
            {/* 4 divs  */}
