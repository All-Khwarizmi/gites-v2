...
const KawanModalLG = ({ slides }: any) => {
  ...
  return (
    <div className="w-50 flex  place-items-center content-center justify-center rounded  bg-black mt-2 transition  delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110">
      <h3
        onClick={onOpen}
                  ...
                  <div className="grid w-full content-end pl-5 ">
                    <div className="  ">
                      ...
                      <ul className="list-disc pl-5">
                        ...
                        <li>deux salle de bain avec douche et WC</li>
