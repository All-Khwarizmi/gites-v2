...
const Localisation = () => {
  ...
  return (
    <div className="grid-row grid place-items-center ">
      ...
      <div className="  flex-row align-center items-center justify-center gap-4 p-5 lg:flex lg:w-[70%]">
        ...
        <div className=" flex justify-center items-center md:h-[100%] md:w-full lg:bg-white ">
          <div>
