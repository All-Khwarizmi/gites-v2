    ...
    <>
      ...
      <div className=" grid  place-items-center gap-5  lg:flex ">
        ...
        <div className="w-[80%] gap-3 bg-gray-100 lg:m-0 lg:w-[50%]  ">
          ...
          <div className="mt-5 flex w-40 place-items-center content-center  justify-center rounded bg-black  transition delay-150 duration-300  ease-in-out hover:-translate-y-1 hover:scale-110 lg:hidden ">
