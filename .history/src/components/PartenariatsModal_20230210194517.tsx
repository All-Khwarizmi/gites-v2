              ...
              <div className="">
                <div className="pb-5">
                  <div className="py-1 px-2">
                    ...
                    Organisation de séjour : KARUKERA HOLIDAYS : locations de
                    véhicules de tourisme avec transferts aéroport, activités
                    touristiques, VTC www.karukeraholidays.com EYESCARAÏBES :
                    organisations de sorties, activités touristiques dans toute
                    la Guadeloupe par des conseillers suivant vos envies,
                    www.eyescaraibes.com
                    <h3
                      className={clsx(
                        cabin.className,
                        "text-md py-2 font-bold uppercase"
