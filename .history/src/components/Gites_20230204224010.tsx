...
const Gites = () => {
  return (
    <div className="grid grid-rows-3 place-items-center gap-3 lg:grid lg:grid-cols-3">
      <div className="lg:h-500 rotate-x-6 group relative flex skew-y-3 cursor-pointer justify-center overflow-hidden rounded-md px-4 text-center lg:w-[80%] ">
        <img
      ...
      <div className="lg:h-500 group relative flex -skew-y-3 cursor-pointer justify-center overflow-hidden rounded-md px-4 text-center lg:w-[80%] ">
        <img
