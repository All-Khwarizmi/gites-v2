...
const Contact = () => {
  ...
  return (
    <>
      <div className="grid w-full place-items-center lg:absolute lg:top-26">
        <div className="eight w-2/3 py-10 pt-32 lg:pt-0 lg:pb-0">
          <h1>Contact</h1>
        </div>
      </div>
      {/* 1st div container */}
      <div className="relative grid  place-items-center gap-5 lg:relative lg:grid lg:w-full ">
        {/* Form div */}
        <div className="div-form mt-1 w-[80%] gap-3 bg-gray-100 px-5 lg:absolute lg:top-40 lg:right-20 lg:m-0 lg:min-h-[50%]  lg:w-[50%] lg:p-2">
          <form
            ref={form}
