...
const Contact = () => {
  ...
  return (
    <>
      ...
      {/* 1st div container */}
      <div className="relative grid  place-items-center gap-5 lg:flex  lg:w-full ">
        <div>

        {/* Form div */}
        <div className="div-form  w-[80%] gap-3 bg-gray-100 px-5 lg:top-40 :m-0 lg:min-h-[50%]   lg:p-2">
          <form
            ref={form}
