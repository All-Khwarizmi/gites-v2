          ...
          <ModalContent>
            ...
            <ModalFooter>
              <div className="grid w-full grid-cols-2 items-center gap-5">
                <div className="fbtn-div flex place-items-center  content-center justify-center rounded transition  delay-150 duration-300 ease-in-out   hover:-translate-y-1 hover:scale-110 lg:hidden">
                  <Link href={"#section-5"}>
                    <h3
                      onClick={onClose}
                      className="  btn-blk w-40 rounded px-4 py-2  text-center text-2xl transition  "
