  ...
  return (
    <div className="grid-rows grid place-items-center gap-3 lg:grid lg:grid-cols-3">
      <div className="flex-row  gap-10">
        ...
        <div className="rounded bg-white bg-blue-500 transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 w-1/4 ">
