              ...
              <div className="">
                <div className="pb-5">
                  <div className="py-1 px-2">
                    ...
                    ></h3>
                    Croisières : excursions en catamaran vers Petite Terre ou
                    Marie-Galante, www.paradoxe-croisieres.com Location de
                    voitures : EUROPCAR, www.europcar-guadeloupe.com (code promo
                    : treso14) ANOLIS CAR, www.anoliscar.fr JUMBO CAR,
