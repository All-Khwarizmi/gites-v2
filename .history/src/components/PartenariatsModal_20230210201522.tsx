              ...
              <div className="">
                <div className="pb-5">
                  <div className="py-1 px-2">
                    ...
                    activités nautiques (jet-ski, bouées
                    tractées, parachute ascensionnel, flyboard), réduction à
                    voir sur place (https://www.caraibesflyboard.com)
                    <div className="py-2 pl-2">
                      <a
                        className="text-blue-400 underline"
                        href="https://www.eyescaraibes.com "
                    ...
                    Sea Step & Sun : découverte de la mangrove au départ de
                    Petit Canal sur des paddles à pédales, appelés step paddle
                    (https://step-paddle-guadeloupe.business.site){" "}
                    <div className="py-2 pl-2">
                      <a
                        className="text-blue-400 underline"
                        href="https://www.eyescaraibes.com "
