...
const Layout= ({ children }: React.PropsWithChildren<{}>) => {
  ...
  <li className="mr-6">
    <a className="text-white text-2xl text-justify hover:text-blue-800" href="#">Cont</a>
  </li>
  <li className="mr-6">
    <a className="text-white text-2xl text-justify hover:text-blue-800" href="#">Link</a>
  </li>
  <li className="mr-6">
