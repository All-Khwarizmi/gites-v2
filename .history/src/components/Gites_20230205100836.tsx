  ...
  return (
    <div className="grid-rows grid place-items-center gap-3 lg:grid lg:grid-cols-3">
      <div className="flex-row place-items-center content-center  gap-10">
        ...
        <div className="flex-column w-1/5 place-items-center content-center justify-center rounded bg-white bg-blue-500 text-center transition delay-150 duration-300 ease-in-out  hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 ">
