...
const Contact = () => {
  ...
  return (
    <>
      {/* 1st div container */}
      <div className="h-screen w-full grid gap-3 place-items-center justify-center lg:relative">
        {/* Form div */}
        <div className="top-40 right-20 m-0 lg:min-h-[50%] w-[50%] place-items-center justify-center gap-3  bg-gray-100 lg:absolute">
          <form
