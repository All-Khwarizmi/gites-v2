      ...
      <div className=" grid  place-items-center gap-5  lg:flex ">
        ...
        <div className="w-[80%] gap-3 bg-gray-100 lg:m-0 lg:w-[50%]  ">
          <form
            ...
            onSubmit={onSubmit}
          >
            <label className="py-2 pt-1">Nom</label>
            <input className="" {...register("lastName", { required: true })} />
            <label className="py-2 pt-1">Prénom</label>
            <input {...register("user_name", { required: true })} />
            <label className="py-2 pt-1">Téléphone</label>
            <input {...register("user_number", { required: true })} />
            <label className="py-2 pt-1">Email</label>
            <input {...register("user_email", { required: true })} />
            <label className="pt-5 py-2" htmlFor="message">
              Message
            </label>
            <textarea
              cols={20}
