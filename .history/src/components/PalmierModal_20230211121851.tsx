          ...
          <ModalContent>
            <ModalHeader className="text-center">
              <h3
                className={clsx(
                  cabin.className,
                  "btn-blk w-60 rounded px-4 py-2 text-center  text-3xl font-bold   transition"
                )}
              >
                {" "}
                Gîte Palmier
            ...
            >
              ...
              <div className="">
                <div className=" ">
                  ...
                  <div className="roudend mt-2 bg-gray-200 p-2">
                    <p>Parking</p>
                    <p>Wifi</p>
                    <p>Accès à la piscine et au barbecue</p>
                    <p>Climatisation dans les chambres (20h à 8h)</p>
                    <p>Linge fournis (draps, linge de toilette, torchons)</p>
                  </div>
                </div>
              </div>
            </ModalBody>
