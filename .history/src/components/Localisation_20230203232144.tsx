...
const Localisation = () => {
  ...
  return (
    <>
      <div className="location align-center flex items-center justify-center p-3"></div>
      <div className="section-location flex  justify-center">
        <p className="text-extra-bold w-30 rounded bg-white p-2">
          Où nous trouver
        </p>
      </div>

      <div className="location align-center p-3">
        <a
