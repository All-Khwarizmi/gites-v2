...
const AnanasModal = ({slides}: any) => {
 ...
 const diapos = slides.slidesAnanas;
  ...
  return (
    <div className="flex place-items-center content-center  btn-div justify-center bg-black rounded lg:hidden ">
      <h3
        onClick={onOpen}
        className=" w-40 rounded   btn-blk px-4 py-2 text-center text-2xl  "
      >
        Gîte Ananas
      </h3>
      <div>
