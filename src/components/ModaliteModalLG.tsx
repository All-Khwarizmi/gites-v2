...
const ModaliteModalLG = () => {
  ...
  return (
    <div className="w-50 md:flex  place-items-center content-center justify-center rounded  bg-black transition delay-150  duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 lg:block hidden ">
      <h3
        onClick={onOpen}
        className={clsx(
          cabin.className,
          ...
          <ModalContent className="py-8"> 
            <ModalHeader className="text-center">
              <h3
                className={clsx(
                  cabin.className,
                  "btn-blk w-50  rounded px-4 py-0 text-center  text-3xl font-bold   transition"
                )}
              >
                {" "}
                Modalités de réservation
            ...
            >
              ...
              <div className="">
                <div className="pb-5">
                  <p className="px-2">
                    Possibilité d’une 5ème personne (enfant), uniquement dans les
